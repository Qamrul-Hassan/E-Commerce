...
const TopCategories = () => {
  ...
  return (
    <div className="top-categories bg-[#F6F7FB] shadow-lg p-6 rounded-md">
      <h2 className="text-center text-2xl font-bold text-[#151875] mb-8">Top Categories</h2>
      <div className="grid grid-cols-4 gap-6">
        {categories.map((item, index) => (
          <div key={index} className="relative flex flex-col items-center p-4 bg-white rounded-lg shadow group">
            
           
            <div className="w-[220px] h-[220px] bg-[#F1F0FF] rounded-full overflow-hidden relative group">
              <img
                src={item.img}
              ...
              <div className="absolute inset-0 border-4 border-transparent group-hover:border-blue-500 group-hover:border-l-4 group-hover:border-b-4 transition-all"></div>
