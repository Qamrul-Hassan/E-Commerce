  ...
  return (
    <div>
      ...
      <div className="relative bg-white h-16 flex items-center justify-between px-6 md:px-10 shadow-md">
        ...
        {/* Mobile Navigation */}
        <div
          className={`fixed top-0 left-0 w-1/2 h-[70%] rounded-2xl bg-[#7E33E0] shadow-lg z-50 py-8 px-6 mobile-menu transform transition-transform duration-500 ease-in-out  ${
