...
const LoginPage = () => {
  return (
    <PageLayout pageTitle="My Account">
      ...
      <div className="relative w-full flex justify-center mt-8"> {/* Adjusted margin-top here */}
        <img
          src={illustration}
          alt="Illustration"
          className="w-full max-w-[800px] h-[75px] object-contain absolute left-1/2 transform -translate-x-1/2"
        />
      </div>
    </PageLayout>
  );
